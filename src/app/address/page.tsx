      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Visit us at our offices across India or contact us for assistance
          </p>
        </div>

        {/* Main Office - Amritsar */}
        <div className="mb-20">
            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 p-10 border border-white/50 transform hover:-translate-y-2">
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                  Our main headquarters located in the heart of Amritsar,
                  <span className="text-orange-600 font-medium">
                    {" "}
                    serving as the central hub for all our operations
                  </span>
                  .
                </p>
                  ...
                  <div className="flex items-start group/item">
                    ...
                    <div>
                      ...
                      <span className="text-gray-700 leading-relaxed">
                        second Floor ,Bhopal electronics building, chhehratha
                        Rd,
                        <br />
                        Ghannu pur kale mode
                        <br />
                        Amritsar, Punjab
                      </span>
                    </div>
            ...
            <figure className="group relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-white/50 transform hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 italic leading-relaxed">
                  Our main office in Amritsar serves as the central hub for all
                  operations, providing comprehensive travel services across
                  India.
                </p>
              </div>
            </figure>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600 text-sm">
                      180 H Freedom Fighters Enclave ,Neb Sarai,Sainik Farm,
                      <br />
                      New Delhi
                    </span>
                  </div>
            ...
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 border border-white/50 transform hover:-translate-y-2">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-gradient-to-r from-pink-500 to-rose-600 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                  <svg
                    className="w-6 h-6 text-white"
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg
                    className="w-5 h-5 text-pink-500 mr-3 mt-1 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    ...
                    <span className="text-gray-600 text-sm">
                      1005,10th floor ,Arhiant dynasty ,Parrikar Colony,
                      <br />
                      Mansarovar,Jaipur
                    </span>
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600 text-sm">
                      Flat No 203, 2nd Flr, Avantika Residency, Belavali,
                      <br />
                      Near Thakrey Garden, opp. Chamunda Vihar Society,
                      <br />
